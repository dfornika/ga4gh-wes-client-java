 ...
 */
@Schema(description = "A message containing useful information about the running service, including supported versions and default settings.")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-03-21T18:04:40.054Z[GMT]")public class ServiceInfo {
  ...
  @SerializedName("workflow_engine_versions")
  private Map<String, String> workflowEngineVersions = null;

  @SerializedName("default_workflow_engine_parameters")
  ...
  @SerializedName("auth_instructions_url")
  private String authInstructionsUrl = null;

  @SerializedName("contact_info_url")
  ...
  **/
  @Schema(description = "A map with keys as the workflow format type name (currently only CWL and WDL are used although a service may support others) and value is a workflow_type_version object which simply contains an array of one or more version strings")
  ...
  **/
  @Schema(description = "The version(s) of the WES schema supported by this service")
  ...
  **/
  @Schema(description = "The filesystem protocols supported by this service, currently these may include common protocols using the terms 'http', 'https', 'sftp', 's3', 'gs', 'file', or 'synapse', but others  are possible and the terms beyond these core protocols are currently not fixed.   This section reports those protocols (either common or not) supported by this WES service.")
  ...
  **/
  @Schema(description = "The engine(s) used by this WES service, key is engine name (e.g. Cromwell) and value is version")
  ...
  **/
  @Schema(description = "Each workflow engine can present additional parameters that can be sent to the workflow engine. This message will list the default values, and their types for each workflow engine.")
  ...
  **/
  @Schema(description = "The system statistics, key is the statistic, value is the count of runs in that state. See the State enum for the possible keys.")
  ...
  **/
  @Schema(description = "A web page URL with human-readable instructions on how to get an authorization token for use with a specific WES endpoint.          ")
  ...
  **/
  @Schema(description = "An email address URL (mailto:) or web page URL with contact information for the operator of a specific WES endpoint.  Users of the endpoint should use this to report problems or security vulnerabilities.")
  ...
  * @return tags
  **/
  @Schema(description = "A key-value map of arbitrary, extended metadata outside the scope of the above but useful to report back")
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(workflowTypeVersions, supportedWesVersions, supportedFilesystemProtocols, workflowEngineVersions, defaultWorkflowEngineParameters, systemStateCounts, authInstructionsUrl, contactInfoUrl, tags);
  }
